...
class DSDefaultCellSubview: UIView {
    ...
    var selectionFont: UIFont?
    var nonSelectionFont: UIFont?
...
extension DSDefaultCellSubview: DSSubview {    
    ...
    func wentInsideSelectionArea() {
        ...
        self.updateTitleFont(self.selectionFont)
    }
    
    func wentOutsideSelectionArea() {
        self.updateTitleColor(nonSelectionColor)
        self.updateTitleFont(self.nonSelectionFont)
    }
    ...
    func initialSetup(_ data: Any?, viewType: DSInitialSetupViewType) {
        ...
        self.assignTextColors(uiConfigs: uiConfigs, viewType: viewType)
        ...
        self.assignSelectionFont(uiConfigs: uiConfigs, viewType: viewType)
    }
    
    private func assignTextColors(uiConfigs: DSDataModel.DSUIConfigs, viewType: DSInitialSetupViewType) {
        switch viewType {
        case .initialView:
            self.selectionColor = uiConfigs.initialFontColor
        case .finalView:
            self.selectionColor = uiConfigs.finalFontColor
            self.nonSelectionColor = uiConfigs.defaultSubviewNonSelectionColor
        }
    }
    
    private func assignSelectionFont(uiConfigs: DSDataModel.DSUIConfigs, viewType: DSInitialSetupViewType) {
        switch viewType {
        case .initialView:
            //selection and non selection is not valid in initial view
            break
        case .finalView:
            self.selectionFont = uiConfigs.finalFont
            self.nonSelectionFont = uiConfigs.finalTitleNonSelectionStateFont
        }
    }
